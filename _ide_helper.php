 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Painless\BreezeMultiAuth\MultiAuthRouteMethods::multiauth()
         * @param mixed $namespace
         * @param mixed $guard
         * @param mixed $options
         * @static 
         */ 
        public static function multiauth($namespace, $guard, $options = [])
        {
                        return \Illuminate\Routing\Router::multiauth($namespace, $guard, $options);
        }
