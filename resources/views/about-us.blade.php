    ...
    <section class="page-section bg-primary text-white my-5" id="about">
        <div class="container mt-5">
            ...
            <div class="divider-custom divider-light">
                ...
                <div class="divider-custom-icon"><svg class="svg-inline--fa fa-star fa-w-18" aria-hidden="true"
            ...
            <div class="text-center mt-4">
                <a class="btn btn-xl btn-outline-light" href="https://startbootstrap.com/theme/freelancer/">
                    <svg class="svg-inline--fa fa-download fa-w-16 mr-2" aria-hidden="true" focusable="false"
                    ...
                    </svg><!-- <i class="fas fa-download mr-2"></i> Font Awesome fontawesome.com -->
                    Free Download!
                </a>
            </div>
        </div>
